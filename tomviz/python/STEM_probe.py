...
class STEM_probe(tomviz.nodes.SourceNode):

    def produce(self, voltage=300.0, alpha_max=30.0, Nxy=256, Nz=512,
        ...
        arr = np.zeros((Nxy, Nxy, Nz), dtype=np.float32, order='F')

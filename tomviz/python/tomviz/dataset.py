...
class Dataset(ABC):
    ...
    stacks and volumetric data, including scalar fields, spacing information,
    tilt series metadata, and calibration data (dark/white fields).

    .. note::
       Concrete subclasses of this ABC are internal to tomviz. This documentation
       describes the public API that is accessible on Dataset instances passed to
       operators and other user-facing code. Users should interact with Dataset
       objects through this interface rather than instantiating subclasses directly.

    This is an abstract base class that defines the interface that all concrete
    Dataset implementations must provide. Subclasses are guaranteed to implement
    all abstract methods and properties.
    """
    @property
    @abstractmethod
    def active_scalars(self) -> np.ndarray:
        """The currently active scalar field data as a numpy array.

        The shape and dtype depend on the specific dataset and scalar field.
        """
        pass
    ...
    def active_scalars(self, v: np.ndarray):
        """Set the currently active scalar field data.

        The array must be compatible with the dataset's expected shape and data type.
        """
        pass
    ...
    def active_name(self) -> str:
        """The name of the currently active scalar field."""
        pass

    @property
    @abstractmethod
    def num_scalars(self) -> int:
        """The total number of scalar fields stored in this dataset."""
        pass

    @property
    @abstractmethod
    def scalars_names(self) -> list[str]:
        """List containing the name of each scalar field in the dataset."""
        pass
    ...
    def scalars(self, name: str | None = None) -> np.ndarray:
        ...
        :param name: The name of the scalar field to retrieve. If None, returns the
                     active scalar field.
        :return: The requested scalar field data.
    ...
    def set_scalars(self, name: str, array: np.ndarray):
        """Add or update a scalar field in the dataset.

        :param name: The name to assign to this scalar field. If a field with this name
                     already exists, it will be overwritten.
        :param array: The scalar field data to store.
        """
        pass
    ...
    def tilt_angles(self, v: np.ndarray | None):
        ...
        Pass None to clear tilt angles.
        """
        pass
    ...
    def tilt_axis(self, v: int | None):
        """Set the axis around which tilting occurs.

        Use 0 for x-axis, 1 for y-axis, 2 for z-axis, or None to clear.
        """
        pass
    ...
    def create_child_dataset(self) -> 'Dataset':
        ...
        may represent derived or processed versions of the data. The exact

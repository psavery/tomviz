...
// Inline utilities (originally from tomviz/Utilities.h) to avoid depending
// on the main tomviz target.
namespace tomviz {

static double offWhite[3] = { 204.0 / 255, 204.0 / 255, 204.0 / 255 };

static double getVoxelValue(vtkImageData* data, const vtkVector3d& point,

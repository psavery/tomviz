...
public:
  ...
  bool updateChildDataSource(Python::Dict output, vtkDataObject* data);
  ...
  void setOutputDataSource(DataSource* source) override;
...
signals:
  ...
  /// a new vtkDataObject.
  void outputDataUpdated(vtkSmartPointer<vtkDataObject>);
